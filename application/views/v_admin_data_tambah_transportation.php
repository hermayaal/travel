    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="active"><a href=<?php echo base_url("admin/transportation"); ?>><i class="fa fa-table"></i> Data Transportation</a></li>
              ...
              <div class="box-body">
                ...
                <form  action=<?php echo base_url("crud/tambah_aksi"); ?> method="post">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label >Seat Quality</label>
                      <input type="text" class="form-control" name="seat_qyt"/>
                    </div>
                    <div class="form-group">
                      <label >Transportation Tyoe ID</label>
                      <input type="text" class="form-control" name="transportation_typeid"/>
                    </div>
                  </div>
                  <!-- /.box-body -->
