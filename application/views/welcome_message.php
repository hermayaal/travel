...
<head>
	...
	<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false);
		...
		<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/owl.carousel.css" type="text/css" media="all"/> <!-- Owl-Carousel-CSS -->
							...
							<nav class="navbar navbar-default">
								<div class="navbar-header navbar-left">
									...
									<div class="w3_navigation_pos">
										<h1><a href="index.html"><span>T</span>ravel <span>U</span>KK</a></h1>
									</div>
								</div>
					...
					<div class="banner-text"> 
						...
						<div class="book-form" id="register">
							...
							<form action="#" method="post">
								...
								<div class="col-md-2 form-left-agileits-submit">
			...
			<div class="services" id="services">
				<div class="container">
					...
					<div class="col-md-5 services-left-agileinfo">
						<div class="profile-pic-w3ls">
							<div class="pic-w3layouts">
								<img src="<?php echo base_url(); ?>assets/images/prof1.jpg" alt="Image">
							</div>
					...
					<div class="col-md-7 services-right-agileits">
						...
						<div class="profile-pic-w3ls">
							<div class="pic-w3layouts">
								<img src="<?php echo base_url(); ?>assets/images/prof2.jpg" alt="Image">
							</div>
						...
						<div class="gallery-grids">
							<div class="col-md-4 col-sm-4 col-xs-6 gallery-grid-img"> 
								<a class="example-image-link w3-agilepic" href="images/s1.jpg" data-lightbox="example-set" data-title="">
									<img class="example-image img-responsive" src="<?php echo base_url(); ?>assets/images/s1.jpg" alt=""/> 
							...
							<div class="col-md-4 col-sm-4 col-xs-6 gallery-grid-img hover ehover14">
								<a class="example-image-link w3-agilepic" href="images/s2.jpg" data-lightbox="example-set" data-title="">
									<img class="example-image img-responsive" src="<?php echo base_url(); ?>assets/images/s2.jpg" alt=""/> 
									<div class="w3ls-overlay">
										<h4>Destinations</h4>
									</div> 
								</a> 
							...
							<div class="col-md-4 col-sm-4 col-xs-6 gallery-grid-img hover ehover14">
								<a class="example-image-link w3-agilepic" href="images/s3.jpg" data-lightbox="example-set" data-title="">
									<img class="example-image img-responsive" src="<?php echo base_url(); ?>assets/images/s3.jpg" alt=""/> 
									<div class="w3ls-overlay">
										<h4>Destinations</h4>
									</div> 
								</a> 
							...
							<div class="col-md-6 col-sm-6 col-xs-6 gallery-grid-img gallery-mdl hover ehover14"> 
								<a class="example-image-link w3-agilepic" href="images/s4.jpg" data-lightbox="example-set" data-title="">
									<img class="example-image img-responsive" src="<?php echo base_url(); ?>assets/images/s4.jpg" alt=""/> 
									<div class="w3ls-overlay">
										<h4>Destinations</h4>
									</div> 
								</a>
							...
							<div class="col-md-6 col-sm-6 col-xs-6 gallery-grid-img gallery-mdl hover ehover14">
								<a class="example-image-link w3-agilepic" href="images/s5.jpg" data-lightbox="example-set" data-title="">
									<img class="example-image img-responsive" src="<?php echo base_url(); ?>assets/images/s5.jpg" alt=""/>
									<div class="w3ls-overlay">
										<h4>Destinations</h4>
									</div> 
								</a> 
							...
							<div class="col-md-4 col-sm-4 col-xs-6 gallery-grid-img hover ehover14"> 
								<a class="example-image-link w3-agilepic" href="images/s6.jpg" data-lightbox="example-set" data-title="">
									<img class="example-image img-responsive" src="<?php echo base_url(); ?>assets/images/s6.jpg" alt=""/>
									<div class="w3ls-overlay">
										<h4>Destinations</h4>
									</div> 
								</a> 
							...
							<div class="col-md-4 col-sm-4 col-xs-6 gallery-grid-img hover ehover14">
								<a class="example-image-link w3-agilepic" href="images/s7.jpg" data-lightbox="example-set" data-title="">
									<img class="example-image img-responsive" src="<?php echo base_url(); ?>assets/images/s7.jpg" alt=""/> 
									<div class="w3ls-overlay">
										<h4>Destinations</h4>
									</div> 
								</a> 
							...
							<div class="col-md-4 col-sm-4 col-xs-6 gallery-grid-img hover ehover14">
								<a class="example-image-link w3-agilepic" href="images/s8.jpg" data-lightbox="example-set" data-title="">
									<img class="example-image img-responsive" src="<?php echo base_url(); ?>assets/images/s8.jpg" alt=""/>
									<div class="w3ls-overlay">
										<h4>Destinations</h4>
									</div> 
								</a>
											...
											<li>
												...
												<li>
													<div class="w3_testimonials_grid_left">
														...
														<div class="w3_testimonials_grid_right">
															<img src="<?php echo base_url(); ?>assets/images/test4.jpg" alt=" " class="img-responsive" />
														</div>
													</li>
												</ul>
											</div>
