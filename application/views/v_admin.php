...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>gudang/adminlte/plugins/iCheck/flat/blue.css">
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>gudang/adminlte/plugins/morris/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>gudang/adminlte/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>gudang/adminlte/plugins/datepicker/datepicker3.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>gudang/adminlte/plugins/daterangepicker/daterangepicker.css">
  <!-- bootstrap wysihtml5 - text editor -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>gudang/adminlte/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="active"><a href=<?php echo base_url("admin"); ?>><i class="fa fa-circle-o"></i> Overview</a></li>
          ...
          <table id="data_user" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo $u->price; ?></td>
                <td><?php echo $u->transportationid; ?></td>
                <td>
                  <a href=<?php echo base_url("crud/edit/".$u->id); ?> class="btn btn-primary a-btn-slide-text">
                    <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                    <span><strong>Edit</strong></span>            
  ...
  <div class="col-xs-12">
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <tbody>
          <?php  foreach ($transportation as $u) { ?>
          <tr>
            <td><?php echo $u->id; ?></td>
            <td><?php echo $u->code; ?></td>
            <td><?php echo $u->description; ?></td>
            <td><?php echo $u->seat_qty; ?></td>
            <td><?php echo $u->transportation_typeid; ?></td>
            <td>
              <a href=<?php echo base_url("crud/edit/".$u->id); ?> class="btn btn-primary a-btn-slide-text">
                <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                <span><strong>Edit</strong></span>            
  ...
  <div class="col-xs-12">
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <tbody>
          <?php  foreach ($transportation_type as $u) { ?>
          <tr>
            <td><?php echo $u->id; ?></td>
            <td><?php echo $u->description; ?></td>
            <td>
...
<script src="<?php echo base_url(); ?>gudang/adminlte/plugins/morris/morris.min.js"></script>
<!-- Sparkline -->
<script src="<?php echo base_url(); ?>gudang/adminlte/plugins/sparkline/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
<script src="<?php echo base_url(); ?>gudang/adminlte/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="<?php echo base_url(); ?>gudang/adminlte/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="<?php echo base_url(); ?>gudang/adminlte/plugins/knob/jquery.knob.js"></script>
<!-- daterangepicker -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"></script>
<script src="<?php echo base_url(); ?>gudang/adminlte/plugins/daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="<?php echo base_url(); ?>gudang/adminlte/plugins/datepicker/bootstrap-datepicker.js"></script>

<!-- Bootstrap WYSIHTML5 -->
<script src="<?php echo base_url(); ?>gudang/adminlte/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
...
<script src="<?php echo base_url(); ?>gudang/adminlte/dist/js/pages/dashboard.js"></script>
